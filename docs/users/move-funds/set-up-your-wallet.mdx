...
familiar with the MetaMask wallet.
...
After you've installed MetaMask, switch to Linea using the network switcher; if you need
assistance, follow [MetaMask's instructions here](https://support.metamask.io/hc/en-us/articles/16367251716251).

## Use Linea on MetaMask
...
[View the MetaMask instructions](https://support.metamask.io/hc/en-us/articles/16367251716251)
for more information.

### Linea Sepolia

To connect to Linea Sepolia testnet, select **Show test networks**, as indicated in the image 
below, and then select the Linea Sepolia.
...
find the relevant network information [here](/developers/quickstart/info-contracts).
