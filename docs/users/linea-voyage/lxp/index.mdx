...
To learn more about the Linea Voyage program, click [here](https://support.linea.build/linea-voyage/linea-voyage-xp-tokens-lxp-faqs).
...
Refer to the support guide [here](https://support.linea.build/linea-voyage/lxp-binding-an-account-from-a-different-secret-recovery-phrase-).
