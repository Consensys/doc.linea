...
description: Build a frontend app using Dynamic and interact with your contract
sidebar_position: 2
...
is to create a frontend app that enables users to connect their wallet and interact.
...
Now that you have a grasp of the basics, you can start to experiment and build apps that enrich 
the Linea ecosystem. Here are some ideas for taking your app to the next level:
