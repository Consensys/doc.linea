...
#### Claim manually on the block explorer

In the native bridge app, manual claim transactions are only available in your transaction history
for 90 days. If you need to claim a transfer older than this, you can write directly to the proxy
contracts on the block explorer, filling out the parameters manually. 
...
<Tabs className="my-tabs">
  <TabItem value="L1 -> L2: `claimMessage`">
    ...
    <TabItem value="L2 -> L1: `claimMessageWithProof`">
      ...
      {/* TO DO: complete fields below. example: https://sepolia.etherscan.io/tx/0x3966a5cc783e719b8163309beb37ad20c74ee385e6a886ecbc10599f62453726 */}
...
The postman fee for L1 -> L2 transfers (i.e. deposits to Linea) is now sponsored for all users for 
