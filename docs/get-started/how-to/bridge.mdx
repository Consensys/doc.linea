...
contracts on the block explorer using the `claimMessage` function. 
...
Now locate the `claimMessage` function and click to see its parameters. You'll need to fill these
out to claim your bridged funds:

<div class="center-container">
  <div class="img-large">
    <img
      src="/img/get_started/how_to/bridge/bridge/claim_message_function_parameters.png"
      alt="Claim message function parameters"
    />
  </div>
</div>
