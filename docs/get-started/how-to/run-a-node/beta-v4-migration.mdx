...
Update Besu `genesis.json` per the file [here](https://github.com/Consensys/zk-apps-prod/blob/main/values/operator-linea-besu/config/sepolia/genesis-sepolia.yaml):
