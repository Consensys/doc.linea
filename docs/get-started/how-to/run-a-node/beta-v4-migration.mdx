...
- Linea-specific: A new `linea-besu-package` release is available via Docker: `consensys/linea-besu-package:beta-v4.0-rc16-20251017160038-c1fde94`
...
2. Upgrade to v1.16.x _after_ Linea has updated to Shanghai ([10am UTC, 23 October, 2025](../../../release-notes.mdx#beta-v40)) and _before_
...
You must run this to start Maru _before_ the Paris fork block number detailed in the [release notes](../../../release-notes.mdx#beta-v40)
— block 24787631.
