...
- L1 (Sepolia) RPC URL — required for Maru to track zk-proof verification and
  determine which L2 blocks are finalized
...
Cleanup existing data in `/opt/maru/data` directory that will be used as
`data-path` in Maru Configuration
