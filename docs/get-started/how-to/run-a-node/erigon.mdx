...
This section is undergoing maintenance. Similarly to Ethereum, and as of Linea [Beta v4](../../../release-notes.mdx#beta-v40), 
...
:::info
Ensure you review [Erigon's software and hardware prerequisites](https://erigon.gitbook.io/docs/summary/getting-started/hardware-requirements)
...
[Download and install the Erigon client](https://erigon.gitbook.io/docs/summary/getting-started/installation).
