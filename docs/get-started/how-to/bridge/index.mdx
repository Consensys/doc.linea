...
There are multiple options to bridge tokens (ETH or ERC-20) when you need to provide liquidity. 
...
There are two types of execution fees that can be applied when you are bridging your tokens: the 
postman fee and the anti-DDOS fee. Since the postman fee is only applied during the automatic 
claiming process, execution fees vary depending on _what_ you're bridging and the direction.
