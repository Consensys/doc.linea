...
**Project Settings** to find your Client ID. Copy this value as you'll need it for configuration.
...
The `useWeb3AuthConnect`, `useWeb3AuthDisconnect`, and `useWeb3AuthUser` hooks are used to connect, 
disconnect, and get user information from the wallet. Similarly, many other hooks are available to 
interact with the wallet and blockchain.
