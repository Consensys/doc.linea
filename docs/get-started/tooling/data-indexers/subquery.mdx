...
- Locally on your own computer (or a cloud provider of your choosing). View the
  instructions for [running SubQuery locally](https://academy.subquery.network/indexer/run_publish/run.html).
- Publish to SubQuery's enterprise-level [Managed Service](https://managedservice.subquery.network/), 
  ...
  is also available. [Learn more.](https://academy.subquery.network/indexer/run_publish/run.html).
- Publish to the decentralized [SubQuery Network](https://subquery.network/network), 
  ...
  indexes and services data to the global community in an incentivized and 
