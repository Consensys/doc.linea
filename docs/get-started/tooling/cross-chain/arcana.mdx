...
[Arcana Network](https://arcana.network) offers [Chain Abstraction](https://docs.arcana.network/ca/introduction/ca/) (CA) SDK that integrates with any web3 app and enables app users to beat liquidity fragmentation. Users can view [unified balance](https://docs.arcana.network/concepts/unified-balance) associated with their EoA and spend it on any chain using any third-party wallet.
...
To enable chain abstraction on Linea, Web 3.0 apps must install and integrate with the [Arcana Chain Abstraction SDK](https://www.npmjs.com/package/@arcana/ca-sdk). See [Quick Start Guide](https://docs.arcana.network/quick-start/ca-quick-start/) and the CA [API](https://ca-sdk-ref-guide.netlify.app/) for details. Check out web3 app [integration examples](https://docs.arcana.network/ca/examples/). 
