...
* **Linea Integration Guide:** [docs.metamask.io/embedded-wallets/connect-blockchain/evm/ethereum](https://docs.metamask.io/embedded-wallets/connect-blockchain/evm/ethereum)
