...
the **latest acceptable block, not the target block**. If the sequencer fails to meet the deadline, finalization reverts for that batch. The potential batch failure effectively forces the sequencer to include your transaction.
