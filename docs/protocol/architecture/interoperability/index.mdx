...
This section is the **network to finalization layer** axis.
Calls between two Lineth deployments use a different mechanism.
On a restricted destination, the access control endpoint authorizes the call instead of
permissionless claiming.
See [Deployment interoperability](../../../stack/deployment/deployment-interoperability.mdx).
