...
It's part of the Lineth [sequencer](./index.mdx) responsible for generating the data used by the
...
The sequencer then puts these traces through [trace conflation](./conflation.mdx).
