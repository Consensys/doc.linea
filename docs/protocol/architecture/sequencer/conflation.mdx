...
<GlossaryTerm term="Zero-knowledge proof">ZK proof</GlossaryTerm>, which is published to the
...
a proof."
By conflating multiple blocks into one, Lineth's proving system becomes much more efficient.
