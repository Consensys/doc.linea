...
The example configuration reflects [Linea's Public Mainnet](/network/index.mdx). While this zero-knowledge rollup protocol is agnostic to the finalization layer, this configuration finalizes transactions by submitting proofs to Ethereum Mainnet and temporarily making data available there.
