...
6. Data submission: Lineth contracts define three data-submission models:
   ...
   - Shnarf-only submission for [private validium deployments](../../stack/features/validium), without publishing the compressed batch data to the finalization layer. Supported by the Coordinator. Requires the validium to support the `IAcceptShnarfData` interface.
