...
See the more about [finality](../../network/features/known-finality-state.mdx#transaction-finality)
...
- Understand protocol fees in [predictable pricing](../../network/features/predictable-pricing.mdx) and
  [burn](../tokenomics/burn.mdx).
