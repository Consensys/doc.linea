...
Lineth architecture supports a configurable protocol that delivers developer-ready layer 2 and layer 3 networks, scaling Ethereum by providing an Ethereum-equivalent execution environment.

Operators and network designers configure their stack to shape protocol behavior and trust
...
Lineth (formerly the Linea Stack) is comprised of several broad classes of components:
...
- **On the finalization layer:** The finalization contract validates
  ...
  [finalization layer](../../stack/deployment/data-availability-finalization.mdx).
...
for [private networks](../../stack/evaluate/deployment-models.mdx#private-validium).
