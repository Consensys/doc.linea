...
6. Data submission: the contracts define three data-submission models:
   - Compressed batch data submitted as EIP-4844 blobs. The current Coordinator uses this model for rollup deployments.
   - Compressed batch data submitted as calldata. The current Coordinator does not provide a calldata submitter.
   - Shnarf-only submission for validium deployments, without publishing the compressed batch data. The current Coordinator uses this model for validium deployments.
