...
6. Blob submission: the coordinator submits compressed batch data to the finalization layer as EIP-4844 blob transactions for data availability.
The contracts also define a calldata-based data availability model, but the current Coordinator does not provide a calldata submitter.
