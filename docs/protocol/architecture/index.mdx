...
[Web3Signer](https://docs.web3signer.consensys.io/) is an open-source, remote signing service for Ethereum and other 
...
See the more about [finality](../../network/overview/known-finality-state.mdx#transaction-finality)
