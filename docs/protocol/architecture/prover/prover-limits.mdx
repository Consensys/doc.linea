...
of <GlossaryTerm term="Ethereum Virtual Machine (EVM)">EVM</GlossaryTerm> or Linea <GlossaryTerm term="zkEVM" /> operations (opcodes). Modules can:
...
[Linea source code](https://github.com/LFDT-Lineth/lineth-monorepo/blob/main/docker/config/common/traces-limits-v5.toml). 
