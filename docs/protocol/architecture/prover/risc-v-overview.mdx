...
<GlossaryTerm term="Lineth" /> is evolving toward a RISC-V-based proving architecture. In this
...
[coordinator](../coordinator/index.mdx) still orchestrates proof generation and finality submission
...
5. The [coordinator](../coordinator/index.mdx) submits the resulting proof data to the finalization layer
   according to the network's deployment model.
