...
<GlossaryTerm term="Lineth" /> uses structured reference strings (SRSs) produced by previously completed public
...
2. Uses [PLONK](https://eprint.iacr.org/2019/953) setup to derive circuit-specific proving and verifying keys.
