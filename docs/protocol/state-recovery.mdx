...
data, it also reduces the need for trust in the Linea [sequencer and coordinator](./architecture/index.mdx).
...
To learn how to run a Linea Besu node, see our [guide](../network/how-to/run-a-node/linea-besu.mdx).
