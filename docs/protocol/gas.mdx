...
`linea_estimateGas` is the recommended method for estimating gas on Linea. See our [API reference](/api/reference/linea-estimategas.mdx) and [guide](/network/how-to/gas-fees.mdx) for more information. 
...
and release notes for [Alpha v2](/notices/release-notes.mdx#alpha-v2) and [Alpha v3](/notices/release-notes.mdx#alpha-v30).
