...
EIP-7702 required a new **Arithmetization Version** and new constraints in Linea's zkASM (also
referred to as zkC)—the assembly language used to define the constraints of Linea's zk-EVM
circuits. The upgrade involved:
