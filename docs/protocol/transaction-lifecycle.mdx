...
For [custom deployments](../stack/how-it-works/deployment-models), Linea network operators may configure an alternative finalization layer.
...
[L2 like Linea](./overview.mdx#what-is-linea)
...
The coordinator combines batches into blobs; the prover generates compression proofs.
...
- **Components:** [Prover](./architecture/prover/index.mdx), [tracer](./architecture/sequencer/traces-generator.mdx), [coordinator](./architecture/coordinator.mdx), [Shomei state manager](./reference/repos.mdx#shomei)
- **Finality:** Soft finality (Linea)
...
- Learn more about the [protocol architecture](./architecture/index.mdx)
- Access the [source code](./reference/repos.mdx) underpinning the Linea tech stack
