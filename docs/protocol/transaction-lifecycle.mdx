...
- **Components:** [Prover](./architecture/prover/index.mdx), [tracer](./architecture/sequencer/traces-generator.mdx), [coordinator](./architecture/coordinator.mdx), [Shomei state manager](./repos.mdx#shomei)
- **Finality:** Soft finality (Linea)
...
- Access the [source code](./repos.mdx) underpinning the Linea tech stack
