...
LineaRollup deposits on Ethereum L1 are staked via Lido V3 stVault to generate Beacon chain rewards, which are reported to L2 for distribution. The following is a breakdown of the major components and flows of the Yield Boost system.
...
- **LineaRollup:** Main Linea bridge contract on L1; holds user-deposited ETH and receives staking yield.
