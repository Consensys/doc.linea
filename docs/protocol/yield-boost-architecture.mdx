...
Ossification permanently locks the StakingVault implementation, opting out of future Lido upgrades. Ossification is intiated by the Security Council; the Automation Service then progressively withdraws all staked funds back to the Linea bridge.
