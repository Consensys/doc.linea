...
For general prerequisites, see the [prerequisites guide](../run-your-own-network/prerequisites.mdx).

## Choose an execution client

### Linea Besu (recommended)

[Linea Besu](../../../protocol/repos#linea-besu-upstream) includes Linea-specific plugins enabling:

- [`linea_estimateGas`](../../../api/reference/linea-estimategas) RPC method
- [Sequencer](../../../protocol/architecture/sequencer) functionality
