...
- [Remote signing](../../how-it-works/architecture.mdx#web3signer): Use hardware security modules or cloud key management service key management service (KMS) for signing operations
