...
image: /img/socialCards/production-hardening.jpg
---
...
- **Network isolation**: Deploy internal services ([sequencer](/protocol/sequencer), [coordinator](/protocol/coordinator), [prover](/protocol/prover)) on private networks
- **Firewall rules**: Restrict access to required ports only

### Key management

- **Web3Signer with KMS**: Use hardware security modules or cloud KMS for signing operations
...
- **[Prover](/protocol/prover)**: Multiple prover instances for redundancy
- **RPC nodes**: Multiple RPC nodes behind load balancer

### High availability

- **Active-passive**: Consider active-passive setup for [sequencer](/protocol/sequencer) and [coordinator](/protocol/coordinator)
...
- **CPU**: Allocate sufficient CPU for proof generation ([prover](/protocol/prover))
...
1. Review [What's next](/stack/guides/run-your-own-network/whats-next) for ongoing operations
2. Establish [Operations Guides](/stack/guides/operations-guides) procedures
3. Set up regular maintenance and review cycles

## Related documentation

- <!-- todo: does this need to be built out [Monitoring](/stack/guides/operations-guides/monitoring): Detailed monitoring setup -->
- <!-- todo: does this need to be built out [Backup and recovery](/stack/guides/operations-guides/backup-recovery): Backup procedures -->
...
- [Boundaries & Responsibilities](/stack/how-it-works/boundaries-responsibilities): Security
  considerations
