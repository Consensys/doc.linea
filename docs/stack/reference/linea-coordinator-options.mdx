---
title: Linea Coordinator configuration reference
sidebar_label: Linea Coordinator options
slug: /reference/component-configuration/linea-coordinator-options
description: 'TOML configuration options for the Linea Coordinator, grouped by config file and section.'
draft: false
