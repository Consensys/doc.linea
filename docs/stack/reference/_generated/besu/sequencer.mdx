...
| `--plugin-linea-liveness-signer-type`                          | Liveness transaction signer type                                                                                        | `WEB3SIGNER` | `WEB3SIGNER\|CUSTOM` | Advanced   |
...
| `--plugin-linea-liveness-signer-address`                       | Ethereum address of the liveness transaction signer                                                                     | —            | `EOA_ADDRESS`        | Advanced   |
