...
capabilities used to deploy and operate Linea networks. Lineth provides a shared,
...
as [Linea Mainnet](../network/overview/index.mdx). The interoperability between Linea and Ethereum allows Lineth networks to use Ethereum's digital assets and build within the open and modular DeFi ecosystem.
