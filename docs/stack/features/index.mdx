...
Use this page to scan Lineth capabilities that matter when evaluating a deployment. For design choices and operator responsibilities, continue to [deployment architecture](../how-it-works/index.mdx).
