...
capabilities used to deploy and operate Linea networks. It enables operators to run their own
Layer 2 or Layer 3 networks, anchored to a configurable finalization layer, while inheriting
Linea’s zero-knowledge security guarantees and Ethereum compatibility.
...
The stack is designed to support operators to configure data availability, access control, finalization, and transaction ordering to meet different operational, regulatory, and performance requirements.
...
Learn about the differences between [Linea and Ethereum](../../network/overview/ethereum-differences)
