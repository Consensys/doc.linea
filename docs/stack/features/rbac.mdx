...
Use this page to understand operator-configured access control for protected Lineth (formerly the Linea Stack) RPC, API, and tooling surfaces. For data visibility choices, see [Privacy and data visibility](./validium.mdx).
