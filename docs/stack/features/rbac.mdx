...
description: >-
  Understand how RBAC controls access to protected Lineth RPC, API, and tooling
  surfaces.
sidebar_position: 5
image: /img/socialCards/role-based-access-control.jpg
---

Role-based access control (RBAC) is an operator-configured access-control layer for Lineth (formerly the Linea Stack)
