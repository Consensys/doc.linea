...
[Trust and responsibilities](../how-it-works/trust-model). For where data is
stored and who can see it, see [Privacy and data visibility](./validium).
...
- Access policy: [RBAC](./rbac) on RPC endpoints and API surfaces controls
...
- Data availability arrangement: operators choose where transaction data is
  ...
  [Data availability and finalization](../how-it-works/data-availability-finalization)
...
- Governance and upgrade authority: multisig, governance contract, or timelock
  for privileged roles; see [Security and assurance](./security)
