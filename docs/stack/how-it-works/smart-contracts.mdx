...
**Purpose:**  
Validates zk-SNARK proofs for transaction batches and records finalized state roots on the
finalization layer.
...
- Acts as a canonical protocol contract for message passing between the Linea network and the
  finalization layer
...
In Linea public Mainnet deployments, this contract is commonly referred to as the 
[Message Bridge](../../network/build/contracts.mdx)
and provides rollup settlement and messaging functionality. Operators running private or hybrid
