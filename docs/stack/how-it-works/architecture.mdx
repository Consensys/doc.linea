...
Internal services typically communicate over operator-controlled interfaces--similar to the Engine API used between consensus and execution clients. Traffic between these services remains within the operator’s trusted network boundary and does not traverse public networks.
...
The [sequencer](../../protocol/sequencer/index.mdx) orders transactions and builds blocks according to Linea rules. 
...
The [prover](../../protocol/prover/index.mdx) generates zero-knowledge proofs for state transitions. Provers may be 
...
2. Block building: [sequencer](../../protocol/sequencer/index.mdx) orders and executes transactions into blocks.
...
5. Proof generation: [prover](../../protocol/prover/index.mdx) generates execution proofs for batches.
6. Blob creation: [coordinator](../../protocol/coordinator.mdx) combines batches into blobs; 
[prover](../../protocol/prover/index.mdx) generates compression proofs.
