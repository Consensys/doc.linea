...
Use this page to evaluate who controls what in a Lineth (formerly the Linea Stack) deployment, what participants can verify, and what happens when dependencies fail.
...
What this page does not cover: configuration flags, deployment topology, or component internals. For those, see [Deployment components](./core-components) and [Deployment models](./deployment-models).
...
- [Security and assurance](/stack/features/security)
