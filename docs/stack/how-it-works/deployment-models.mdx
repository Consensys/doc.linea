...
Use this page to compare documented Lineth deployment models and the trade-offs they create for access, data availability, and finalization. Related evaluation paths include [trust and responsibilities](./trust-model.mdx) and [privacy and data visibility](../features/validium.mdx).
