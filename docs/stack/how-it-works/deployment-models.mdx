...
description: >-
  Learn how to choose and configure Linea deployment models for enterprise use
  cases
sidebar_position: 2
image: /img/socialCards/deployment-models.jpg
---

A deployment model describes how a network built on Lineth is configured. Different deployment models allow operators to balance privacy, regulatory requirements, and security guarantees according to their use case. 
...
zero-knowledge proofs to preserve correctness and finality guarantees.
