...
- Continue operating the network and providing services to users. If the network needs to be shut down, properly wind down the network to ensure participants can make exit transactions.
