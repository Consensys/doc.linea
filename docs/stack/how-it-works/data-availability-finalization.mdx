...
description: >-
  Data availability and finalization-layer choices for Lineth deployments
sidebar_position: 3
image: /img/socialCards/data-availability-and-finalization.jpg
---

Use this page to compare data availability and finalization designs for a Lineth deployment and their operator consequences. For application-level versus settlement finality, see [Finality design](../features/fast-finality.mdx).
