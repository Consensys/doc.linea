...
This section covers the considerations operators must take into account when configuring data availability and finalization.

:::important

Understanding the role [data availability and finalization](../../protocol/architecture#data-availability) in the protocol is essential for deploying and operating a Linea network.
...
While zk-SNARK proofs ensure the correctness of state transitions, data availability guarantees that
