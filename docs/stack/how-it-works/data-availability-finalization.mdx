...
Understanding the role [data availability](../../protocol/architecture#data-availability) and [finalization](#finality-design-options) in the protocol is essential for deploying and operating a network built on Lineth.
