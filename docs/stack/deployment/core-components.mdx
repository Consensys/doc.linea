...
This page describes the Lineth (formerly the Linea Stack) components.
It identifies which components an operator must or may run, and describes how they are versioned or replaced. For what each component does internally, see the [Protocol architecture](../../protocol/architecture/index.mdx).
