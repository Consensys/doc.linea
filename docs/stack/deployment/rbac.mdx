...
description: >-
  Operator-configured access policy for protected Lineth RPC, API, and tooling
  surfaces
sidebar_position: 5
image: /img/socialCards/access-control.jpg
---

This page describes operator-configured access control for protected Lineth (formerly the Linea Stack) RPC, API, and tooling surfaces. For data visibility choices, see [Privacy and data visibility](../evaluate/validium.mdx).
...
In a Lineth deployment, RBAC can be used around operator-controlled access surfaces, including:
...
For the broader trust model, see [Trust model](../evaluate/trust-model.mdx).
...
- [Privacy](../evaluate/validium.mdx): how private validium deployments use offchain data availability and
  controlled access.
- [Security](../evaluate/security.mdx): how RBAC fits into operational security controls.
- [Deployment models](../evaluate/deployment-models.mdx): how access control factors into
  deployment design.
