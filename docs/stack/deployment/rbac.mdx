...
This page describes <GlossaryTerm term="Operator">operator</GlossaryTerm>-configured access control for
protected <GlossaryTerm term="Lineth" /> RPC, API, and tooling surfaces.
...
designed for broad availability.
In a <GlossaryTerm term="Validium">private validium</GlossaryTerm> deployment, transaction data may be kept
