...
This page compares data availability and finalization designs for a Lineth deployment and their operator consequences. For application-level versus settlement finality, see [Finality design](./fast-finality.mdx).
