...
flowchart TB
  ...
  POL["RBAC database"]:::neutral
  AUD["Access log"]:::neutral
...
- [Security and assurance](../evaluate/security.mdx): How the privacy proxy fits into operational security controls.
- [Deployment models](../evaluate/deployment-models.mdx): How access control factors into deployment design.
- [RPC services](../../protocol/architecture/rpc-services.mdx): How RPC services expose blockchain data and
  can sit behind access controls.
