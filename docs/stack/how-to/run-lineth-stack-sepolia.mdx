...
local L1 for development and testing. The quickstart starts a local L2
...
- Coordinator for batching, proof orchestration, and submissions
...
Local L1 mode is also available for development, CI, testing, and periods
...
Add `--profile local-l1` when stopping a stack started with
`L1_MODE=local`.
...
- Local L1 mode is for development and testing; it does not prove public
  Sepolia finality.
