...
This page describes who operates each Lineth component, what each component can do, what participants can verify, what happens when dependencies fail, and how trust assumptions change across deployment models.
