...
The [privacy proxy](../deployment/access-control.mdx) controls access to JSON-RPC, APIs, and tooling,
determined by role-based permissions.

Access control restricts who can call an endpoint or view data the
