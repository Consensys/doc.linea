...
After blocks are produced by the <GlossaryTerm term="Sequencer">sequencer</GlossaryTerm>, they are aggregated and
...
- Consensus layer: [Maru](../../protocol/reference/repos.mdx#maru) with
  <GlossaryTerm term="Quorum Byzantine Fault Tolerance (QBFT)">QBFT</GlossaryTerm> consensus (minimum 4 nodes,
