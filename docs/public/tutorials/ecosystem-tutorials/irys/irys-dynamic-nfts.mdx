...
[Irys CLI](../../../tools/permanent-data/irys/irys-quickstart#irys-cli) to "mutate" the
metadata, simulating the automatic changes that would occur through player interactions in an actual game.

## Prerequisites

[Install the Irys CLI](../../../tools/permanent-data/irys/irys-quickstart#irys-cli) to upload
