...
You can use [Irys](../../../tools/permanent-data/irys/overview) to create an NFT on Linea in three steps:
...
This guide covers using the [Irys CLI](../../../tools/permanent-data/irys/irys-quickstart#irys-cli) 
to upload your assets to Irys. You can also do the same using the [Irys SDK](../../../tools/permanent-data/irys/irys-quickstart#irys-sdk).
