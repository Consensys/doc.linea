...
You can get some Linea Sepolia (testnet) ETH [here](../how-to/get-testnet-eth). 

:::info

As Linea uses the **London** version of Ethereum, a small number of recent opcodes are [not available](../build/ethereum-differences).
