...
You can get some Linea Sepolia (testnet) ETH [here](../network/how-to/get-testnet-eth.mdx). 

:::info

As Linea uses the **London** version of Ethereum, a small number of recent opcodes are [not available](../network/build/ethereum-differences.mdx).
