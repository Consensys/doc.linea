...
As Linea uses the **London** version of Ethereum, a small number of recent opcodes are [not available](https://docs.linea.build/get-started/build/ethereum-differences).
...
This is a simplified version of a staking contract with allowlist, so let's take a moment to explain it:
...
4. Enter the list of tokens you want to allowlist. For this tutorial, I've deployed 3 ERC20 contracts that you can use (you can copy and paste directly into the field): 
