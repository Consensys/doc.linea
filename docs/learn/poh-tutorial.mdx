...
This version replaces the complex multi-provider setup that was used for PoH V1, simplifying
...
million wallets to protect our TGE from farmers).
...
For the implementation, visit [this Proof of Humanity guide](https://docs.linea.build/get-started/how-to/verify-users-with-proof-of-humanity)
