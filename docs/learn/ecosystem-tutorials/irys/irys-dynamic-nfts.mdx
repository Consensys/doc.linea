...
<div class="center-container">
  <div class="img-large">
    <img
      src="/img/learn/ecosystem-tutorials/irys/irys_dynamic_nfts/Irys_mutable_references_gateway_url.png"
      alt="Irys mutable references gateway url"
    />
  </div>
</div>
...
<div class="center-container">
  <div class="img-large">
    <img
      src="/img/learn/ecosystem-tutorials/irys/irys_dynamic_nfts/Irys_dynamic_nft_with_mutable_references.png"
      alt=""
    />
  </div>
</div>
...
[Irys CLI](../../../tools/permanent-data/irys/irys-quickstart.mdx#irys-cli) to "mutate" the
metadata, simulating the automatic changes that would occur through player interactions in an actual game.

## Prerequisites

[Install the Irys CLI](../../../tools/permanent-data/irys/irys-quickstart.mdx#irys-cli) to upload
...
[Deploy the smart contract using Remix](../../../network/how-to/deploy-smart-contract/remix.mdx), or
[any other environment](../../../network/how-to/deploy-smart-contract/index.mdx).
...
<div class="center-container">
  <div class="img-large">
    <img
      src="/img/learn/ecosystem-tutorials/irys/irys_dynamic_nfts/Irys_nft_opensea_mockup.png"
      alt="Irys nft opensea mockup"
    />
  </div>
</div>
...
<div class="center-container">
  <div class="img-large">
    <img
      src="/img/learn/ecosystem-tutorials/irys/irys_dynamic_nfts/Irys_nft_opensea_refresh_metadata.png"
      alt="Irys nft opensea refresh metadata"
    />
  </div>
</div>
