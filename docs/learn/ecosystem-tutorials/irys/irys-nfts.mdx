...
You can use [Irys](../../../tools/permanent-data/irys/overview.mdx) to create an NFT on Linea in three steps:
...
one of [the audited ThirdWeb contracts](../../../network/how-to/deploy-smart-contract/thirdweb.mdx) to learn more.

You can also [deploy this minimal contract using Remix](../../../network/how-to/deploy-smart-contract/remix.mdx).
...
This guide covers using the [Irys CLI](../../../tools/permanent-data/irys/irys-quickstart.mdx#irys-cli) 
to upload your assets to Irys. You can also do the same using the [Irys SDK](../../../tools/permanent-data/irys/irys-quickstart.mdx#irys-sdk).
...
using [the contract you deployed on Linea](../../../network/how-to/deploy-smart-contract/index.mdx).
