...
Specific tokens require specific bridges. If you want to bridge from Goerli to Linea, you can find the tokens, contract addresses, and associated bridges [here](./info-contracts.mdx#token-contract-addresses-and-bridges).
  ...
  You can use your local fiat currency to buy ETH or [USDC.e](support.linea.build/hc/en-us/articles/18000020097051) (USDC bridged to Linea) on Linea.
...
<div class="center-container">
    <div class="video-container">
      <iframe
        class="video-iframe"
        src="//www.youtube-nocookie.com/embed/BOPDw348-zg"
        title="TITLE"
...
Before you start, make sure you've connected MetaMask to Portfolio, and that the selected account in Portfolio is the one you want the tokens to arrive in.

1. To get started, head to MetaMask Portfolio and hit the 'Buy' tab on the left of the screen. If you're on a mobile device, use the [MetaMask mobile browser](https://support.metamask.io/hc/articles/6356387482523) to ensure you can connect your wallet, and then select 'Buy' from the hamburger icon menu located in the top left of the screen.

<div class="center-container">
  <div class="img-medium">
    <img
      src="/guide-media/01HFEDQNZAVMR1RPVN5KH7ASPK"
      alt="MetaMask Portfolio buy button"
    />
  </div>
</div>

2. Now you'll see the Buy interface. If you've never used it before, you'll first need to **select your region**. This is because the availability of payment methods and providers vary based on your bank's location.

<div class="center-container">
  <div class="img-medium">
    <img
      src="/guide-media/01HFEDQKFK2ET1580NX9K3JSAY"
      alt="MetaMask Portfolio select region"
    />
  </div>
</div>

3. **Set the payment method**. Again, if you've used Buy before, the browser will remember your previous choice as the default.

<div class="center-container">
  <div class="img-medium">
    <img
      src="/guide-media/01HFEDQM1D640Q9GSPH103VS0P"
      alt="MetaMask Portfolio select payment method"
    />
  </div>
</div>

4. **Select a token**. The token selection menu also allows you to switch networks; it's here where you need to locate and select Linea from the networks list:

<div class="center-container">
  <div class="img-medium">
    <img
      src="/guide-media/01HFEDQHMST54HK5R18MEKWB2P"
      alt="MetaMask Portfolio select network"
    />
  </div>
</div>

5. Now you'll see the tokens available to buy on Linea. Pick the one you want to buy, then input the amount on the main screen once the tokens menu is gone.

<div class="center-container">
  <div class="img-medium">
    <img
      src="/guide-media/01HFEDQEMT2SB61Q25PAF8V75X"
      alt="MetaMask Portfolio select token"
    />
  </div>
</div>

6. You'll instantly see one or more quotes on the right if you're on a desktop browser; on mobile devices, hit 'Get Quotes' to see them. Pick a quote by clicking on it. Selecting a quote redirects you to the provider's site to complete the transaction. You may need to complete KYC ("know your customer"; essentially identifying yourself) with the provider.

<div class="center-container">
  <div class="img-medium">
    <img
      src="/guide-media/01HFEDQFS418ZHH3TAY8RVDNVC"
      alt="MetaMask Portfolio select your quote"
    />
  </div>
</div>

7. After you've completed the steps with the provider, you'll be routed back to MetaMask Portfolio. Timescales for receiving your funds will vary based on the provider and token route.
