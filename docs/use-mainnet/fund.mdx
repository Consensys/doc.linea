...
- Sending a DM to [this XMTP chatbot](https://converse.xyz/dm/0x96561c772533d32da71d240820a2fbf6883cf96a) at TheGeneralStore.eth
...
2. If you're on a mobile device, select 'Buy' from the hamburger icon menu located in the top left of the screen; on desktop, select the 'Buy' tab on the left.
