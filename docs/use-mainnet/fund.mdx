...
[Portfolio](https://portfolio.metamask.io/) is a dapp built by our friends at MetaMask that allows you to buy, sell, swap, stake, and manage your cryptoassets, among other features. The Buy feature is one of these functions, and is the same service available [through MetaMask](https://support.metamask.io/hc/articles/360058239311). ::: :::tip If you already have tokens on another network, you can [follow the instructions here](./bridges-of-linea/bridging-non-dev.mdx) to bridge them to Linea. ::: **Linea purchases in MetaMask Portfolio's Buy feature are available worldwide.**
