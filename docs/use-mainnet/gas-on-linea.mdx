...
Since the process of generating zk proofs and submitting them to L1 is an indispensable and vital feature of Linea, we can consider gas to represent the cost of maintaining the network's security and integrity.
