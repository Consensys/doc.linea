...
Gas must be paid to cover any kind of on-chain computation. For a zk rollup like Linea, this mainly involves executation and storage on L2, and publishing `calldata` on L1.
