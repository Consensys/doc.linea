...
Linea Surge is an LXP-driven program that enables people to collect tokens in return for having 
assets on Linea and gives bonuses for deploying those assets into protocols.
