...
If you've got some ETH on Mainnet, or want to [buy some](https://support.metamask.io/hc/en-us/articles/360058239311), then you'll be able to bridge that ETH up to Linea using the [bridge process outlined here](./bridges-of-linea/index.md).
