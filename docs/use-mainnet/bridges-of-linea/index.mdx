...
<img src={require('@site/static/img/docs/use-mainnet/bridges-of-linea/linea-bridge-connect.png').default}></img>
...
<img src={require('@site/static/img/docs/use-mainnet/bridges-of-linea/token-bridge-step-3.png').default}></img>

5. MetaMask will pop up asking you to confirm the transaction. 

<img src={require('@site/static/img/docs/use-mainnet/bridges-of-linea/metamask-confirmation.png').default}></img>
...
<img src={require('@site/static/img/docs/use-mainnet/bridges-of-linea/pending-transaction-l1-to-l2.png').default}></img>
...
<img src={require('@site/static/img/docs/use-mainnet/bridges-of-linea/confirmed-transaction-l1-to-l2.png').default}></img>
...
<img src={require('@site/static/img/docs/use-mainnet/bridges-of-linea/manual-claiming.png').default}></img>
...
<img src={require('@site/static/img/docs/use-mainnet/bridges-of-linea/claim-funds.png').default}></img>

7. MetaMask will prompt you to switch networks and to also confirm the transaction from the previous step.

<img src={require('@site/static/img/docs/use-mainnet/bridges-of-linea/claim-message-metamask.png').default}></img>
...
<img src={require('@site/static/img/docs/use-mainnet/bridges-of-linea/Confirmation-manual-claim.png').default}></img>
...
<img src={require('@site/static/img/docs/use-mainnet/bridges-of-linea/L2-to-L1-start-bridging.png').default}></img>

5. MetaMask will pop up and ask you to confirm the transaction. 

<img src={require('@site/static/img/docs/use-mainnet/bridges-of-linea/metamask-l2.png').default}></img>
...
<img src={require('@site/static/img/docs/use-mainnet/bridges-of-linea/pending-transaction-L2-L1.png').default}></img>
...
<img src={require('@site/static/img/docs/use-mainnet/bridges-of-linea/claim-message-l2-l1.png').default}></img>
