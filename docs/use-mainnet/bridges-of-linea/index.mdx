...
>
> One of the main reasons you would want a rollup network is for it to be totally interoperable with the L1, and one of the main things you need to make networks interoperable is to enable people to move things back and forth between them. The class of tools used to do this, broadly, are called **bridges**.
>
