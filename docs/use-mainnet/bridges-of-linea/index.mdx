...
_Note: Linea is currently doing a soft launch of Mainnet with specific partners. Public availability will be announced soon. Meanwhile, feel free to check out our [testnet docs](../../build-on-linea/use-linea-testnet/bridge-funds/index.md)_
