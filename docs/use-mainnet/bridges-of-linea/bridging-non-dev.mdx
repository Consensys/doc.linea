...
#### **We recommend you use the Bridge feature of MetaMask Portfolio:**
...
:::info For dapp teams, liquidity providers, and technology operators bridging large amounts of liquidity, please use [this page](/use-mainnet/bridges-of-linea/index.mdx) to see what your best options are.
