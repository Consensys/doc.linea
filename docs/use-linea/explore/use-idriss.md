...
Before you begin, ensure your wallet is [configured to use Linea](../set-up-your-wallet.md) and [funded with Goerli ETH](/docs/use-linea/fund.md#get-test-eth-on-goerli).
