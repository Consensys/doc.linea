...
2. [Bridge some funds](/docs/use-linea/transfer-funds.md)
3. [Deploy your first contract](./../developers/quickstart/)
4. [Get funds from a faucet](/docs/use-linea/fund.md)
5. [Send a transaction](/docs/use-linea/transfer-funds.md)
