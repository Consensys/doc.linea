...
[l2-genesis-uat.json](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/fdc87be5-c9bd-4fa3-9db3-f1ab9ec832dc/l2-genesis-uat.json)
...
<aside>
💡 Please feel free to contact us if you run into issues @ #linea-run
</aside>
<br/>
<aside>
