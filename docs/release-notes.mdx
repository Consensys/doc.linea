...
1. Beta v1.1: Transition to the new arithmetization, and;
2. Beta v1.2: Ensure the new arithmetization is 100% proven.
...
the consistency arguments of the HUB.
- Proof of all the activated modules. 
