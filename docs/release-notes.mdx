...
**Linea Mainnet: Late May 2025** (target)

**Linea Sepolia: Late May 2025** (target)

- **Limitless prover**: Upgrades the prover so that it no longer needs to keep track of [line limits](./technology/prover/prover-limits.mdx),
enabling:
...
**Linea Mainnet: Mid-May 2025** (target)

**Linea Sepolia: Early/mid-May 2025** (target)
...
100% of the zkEVM specification, an objective currently scheduled to be complete in Beta v2.

### Beta v1.4

**Linea Mainnet: April 14, 2025** 

**Linea Sepolia: TBC**

- Adds the `eth_sendBundle` RPC method, enabling apps to protect users against MEV and improve UX
in other ways.
- Introduces state recovery, enabling anyone to recover and audit Linea state, reducing the risk of
