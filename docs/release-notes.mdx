...
We maintain a record and brief explanation of Linea Security Council transactions [here](./security-council-record.mdx).
...
securely querying data on Linea. See our [page on CCIP Read](../docs/tools/cross-chain/ccip-read.mdx) 
