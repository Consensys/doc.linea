...
The following example estimates the cost for transferring an ERC20 token for an account which does not
...
balance within the ERC20 contract's storage for the duration of the call.
