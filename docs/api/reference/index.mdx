...
- **Run your own node**: Either [run your own node by setting it up yourself](../../public/how-to/run-a-node/index.mdx), or
    [use a node provider](../../public/tools/node-providers/index.mdx).
    We recommend running [Linea Besu](../../public/how-to/run-a-node/linea-besu.mdx) if you want to run a node yourself and interact with the
    blockchain.
- **Connect to a private RPC endpoint**: [Connect to a blockchain infrastructure provider](../../public/tools/node-providers/index.mdx#private-rpc-endpoints)
    such as Infura or Alchemy. Multiple providers offer free tier access.
- **Use a public endpoint**: [Public endpoints](../../public/tools/node-providers/index.mdx#public-rpc-endpoints) are
...
:::info
View the [list of node providers](../../public/tools/node-providers/index.mdx) if you require an endpoint.
:::
