...
- **Run your own node**: Either [run your own node by setting it up yourself](../../network/how-to/run-a-node/index.mdx), or
    [use a node provider](../../network/tools/node-providers/index.mdx).
    ...
    blockchain.
- **Connect to a private RPC endpoint**: [Connect to a blockchain infrastructure provider](../../network/tools/node-providers/index.mdx#private-rpc-endpoints)
    such as Infura or Alchemy. Multiple providers offer free tier access.
- **Use a public endpoint**: [Public endpoints](../../network/tools/node-providers/index.mdx#public-rpc-endpoints) are
...
:::info
View the [list of node providers](../../network/tools/node-providers/index.mdx) if you require an endpoint.
:::
