...
`eth_sendRawTransaction` is functionally very similar to the [Ethereum Mainnet equivalent](https://ethereum.org/en/developers/docs/apis/json-rpc/#eth_sendrawtransaction). 
