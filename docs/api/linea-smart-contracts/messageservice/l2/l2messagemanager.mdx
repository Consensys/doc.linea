...
Contains the L1 to L2 messaging rolling hashes mapped to the message number computed on L2.
...
and the rolling hash not calculated, else synchronization will break.
