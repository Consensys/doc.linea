...
Queries a database maintained by the sequencer to check if a tranasction was rejected because it 
exceeded limits that would prevent the prover from generating a proof for the block.

If the transaction was rejected, the API call will be successful and provide details of why. 
...
<Tabs>
    <TabItem value="cURL">
        ...
        -d '{
            ...
            "params": ["0xf5bf951edfefbaa6d9ed78c88942147cf98c8ef1f3d3416f99d2534675096569"],
        }'
        ```
    </TabItem>
</Tabs>
