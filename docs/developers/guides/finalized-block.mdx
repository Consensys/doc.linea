...
A finalized L2 block is a block on a L2 blockchain (Linea) that has been confirmed and validated
...
network. For example, in methods where you can specify a block parameter, such as
