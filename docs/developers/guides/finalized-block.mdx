...
1. Create a JavaScript file (for example `index.js`) and copy the following code:
   ...
   :::info Update the Infura endpoint with your API key, or add a different RPC provider. :::
