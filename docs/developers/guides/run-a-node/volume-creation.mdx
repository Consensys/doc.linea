...
- Choose a maximum size for the volume. We'll use 100GB for this example, but refer to the 
[Geth](./follower/use-binary.mdx#disk-space-geth) or [Besu](./follower/use-binary.mdx#disk-space-besu) explanation 
