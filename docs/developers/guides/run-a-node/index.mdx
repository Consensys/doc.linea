...
:::info important While Linea supports multiple clients, only Linea Besu currently allows you to access Linea-specific features, such as using [Linea methods](../../reference/api/index.mdx) (for example, `linea_estimateGas`) or calling methods using the `finalized` tag.
