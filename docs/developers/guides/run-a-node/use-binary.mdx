...
You must install and run the `linea-sequencer` Besu plugin if you are offering RPC services or 
...
Please see our instructions here for guidance on installing the plugin.
