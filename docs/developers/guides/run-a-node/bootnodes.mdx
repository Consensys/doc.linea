...
The following bootnodes enable your node to find a peer node when initializing.
To optimize performance, we recommend you select a location that corresponds to
you:
...
Choosing a closer region will minimize latency, but any enode will work
