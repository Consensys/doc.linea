...
The following bootnodes enable your node to find a peer node when initializing. To optimize performance, we recommend you select a location that corresponds to you:

- `us-east-2`: United States
- `ap-southeast-1`: Asia-Pacific
- `eu-north-1`: Europe

Choosing a closer region will minimize latency, but any enode will work regardless of the location you choose.
