...
- [Set it up yourself](../../guides/run-a-node/index.mdx)
...
> [`linea_estimateGas`](../../reference/api/linea-estimategas.mdx) API method,
> or features that require a specific implementation to work on Linea, such as
> use of the [`finalized` tag](../../guides/finalized-block.mdx)._
