...
![](/static/img/docs/build-on-linea/tooling/permanent-data/irys/irys-provenance-layer.gif)
...
Transaction metadata can be [queried using the Irys query package](/developers/tooling/permanent-data/irys/irys-query-package).
