...
In the world of web3, attestations can prove digital identity, ownership of
digital assets, and more.

This space is currently rapidly evolving, and use cases for attestations are
still being discovered and built.
