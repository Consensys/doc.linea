...
Linea Mainnet and Linea Sepolia are listed on the official `ethereum-lists/chains` repository that is pulled by many cross-chain projects like Chainlist.org, Thirdweb, and Cookbook.dev.
