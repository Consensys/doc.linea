...
Subgraphs are an open-source tool for building custom GraphQL APIs from onchain
data.

Identify onchain events you want to index, write AssemblyScript handlers to
