...
unique. You can checkout our fully-functional reference deployment
...
- **Out of the box aggregation** - We aggregate all major marketplaces and
  ...
  [here](https://docs.reservoir.tools/reference/supported-marketplaces). We also
  aggregate bid liquidity from across the NFT ecosystem so your users can sell
  instantly into the best available offer.
