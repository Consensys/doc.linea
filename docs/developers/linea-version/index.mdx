...
Read more about ENS in the user guide [here](https://support.linea.build/hc/en-us/27439122478107).
...
securely querying data on Linea. See our [page on CCIP Read](/developers/tooling/cross-chain/ccip-read-gateway) 
...
Consensys Diligence carried out an audit on Linea ENS, available [here](https://consensys.io/diligence/audits/private/fvtlh3i9e7r98d/).
...
- Adds the [`eth_sendRawTransaction`](reference/api/eth-sendrawtransaction) method, 
