...
import zkEVM2 from "!!raw-loader!../abis/2023-06-13-release/zkEVM2.abi";
import L2MessageService from "!!raw-loader!../abis/2023-06-13-release/L2MessageService.abi";
import TokenBridgeL1 from "!!raw-loader!../abis/2023-06-13-release/TokenBridgeL1.abi";
import TokenBridgeL2 from "!!raw-loader!../abis/2023-06-13-release/TokenBridgeL2.abi";
...
> | --- | --- | --- |
> | Linea Goerli | [Alpha v0.2.3](#linea-alpha-v023-june-13-22-23) | June 13, 2020 |

+## Linea Alpha v0.2.3 (June 22, 2023)

### Summary

This release focuses on optimizing the provers hashing strategy to increase its computational efficiency.
...
- Updated the Postman Sdk configuration files to handle zero values and revised gas fee calculations.

## Linea Alpha v0.2.1 (June 15, 2023)

### Summary

This release reduces the gas cost of submitting a batch of transactions on L1 by optimizing calldata that is sent by L2 to L1 logs.

### Features

- Instead of sending the entire event MessageSent, we only send the \_messageHash field of the event.

- **Old calldata for L2 originated message**:
...
- **New calldata for L2 originated messages**:
  ```bash
    //			bytes32 _messageHash
  ```
...
Major changes are applied to the Canonical token bridge as described in our [documentation](../bridge-architecture/canonical-token-bridge.mdx).
...
- **L2 (Linea)**
  ...
  - Contracts
    ...
    - [Implementation](https://explorer.goerli.linea.build/address/0x6081C1392793e22dA39871D4362c1e7045A5bace)
