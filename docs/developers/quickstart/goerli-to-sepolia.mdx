...
You will need to spin up a new node. The method is the same as before, and as detailed in our [guide](../guides/run-a-node). However, you must use new genesis files specific to Linea Sepolia:
...
You can find a more thorough overview of key Linea Sepolia details on our [network info page](./info-contracts). 
