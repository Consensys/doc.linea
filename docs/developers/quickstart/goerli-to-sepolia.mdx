...
Linea Goerli was official decommissioned on May 31 2024.

## Running a Sepolia node

If you run a Linea Goerli testnet node, we recommend you transition to a Linea Sepolia node as soon 
as possible.

You will need to spin up a new node. The method is the same as before, and as detailed in our 
