...
If your dapp is using public endpoints, it may encounter rate limiting. You can find Linea node providers [here](/developers/tooling/node-providers/index).

We recommend connecting to Linea via [private RPCs](/developers/tooling/node-providers/index).
