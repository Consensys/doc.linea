...
If your dapp is using public endpoints, it may encounter rate limiting. You can find Linea node providers [here](../tooling/node-providers/index.mdx).
...
You can use one of the following Linea Sepolia faucets to drip testnet ETH directly to your Linea Sepolia address:
