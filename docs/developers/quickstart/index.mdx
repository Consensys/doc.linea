...
2. Funded your wallet with Linea ETH, either through [bridging](../guides/bridge/index.mdx) or using an on-ramp such as [MetaMask Portfolio](https://portfolio.metamask.io/buy).
