...
Linea's aims to be a fully decentralized, permissionless network. To support this goal, the Linea architecture is made up of three main elements:
...
one to understand what's going on when adding a layer.
...
Linea, and other L2s are designed to participate in the security of Ethereum, 
while optimizing for execution. In other words, L2s support many transactions, run 
...
- Learn more about the different components that make up the [Linea software](architecture/stack).
...
grow. Key these bridges and how they function is the [Linea canonical message service](architecture/stack/canonical-msg-service).
