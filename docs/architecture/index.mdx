...
Linea is in its mainnet alpha release, but there's still lots of development to be done. Currently, the first two sections above are kind of rolled into one:
