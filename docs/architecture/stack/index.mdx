...
Each repository is listed below, together with a description of its purpose. Links to explainers 
of each element of Linea's architecture are available [below](#architecture-documentation).
