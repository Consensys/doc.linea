...
The Ethereum client Hyperledger Besu, extended with Linea plugins.
...
A zk-SNARK library that offers a high-level API to design circuits, the constraint systems that 
produce the proof submitted to L1.
