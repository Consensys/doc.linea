...
> the [`finalized` tag](../../network/how-to/finalized-block.mdx)._

## Run your own node

View our [node running guides](../../network/how-to/run-a-node/index.mdx) to find out how to run a node locally. 
