...
> the [`finalized` tag](../../get-started/how-to/finalized-block.mdx)._

## Run your own node

View our [node running guides](../../get-started/how-to/run-a-node/index.mdx) to find out how to run a node locally. 
