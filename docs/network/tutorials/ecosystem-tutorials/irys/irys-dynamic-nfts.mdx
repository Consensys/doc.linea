...
[Irys CLI](../../../build/tools/permanent-data/irys/irys-quickstart#irys-cli) to "mutate" the
metadata, simulating the automatic changes that would occur through player interactions in an actual game.

## Prerequisites

[Install the Irys CLI](../../../build/tools/permanent-data/irys/irys-quickstart#irys-cli) to upload
...
[Deploy the smart contract using Remix](../../../how-to/deploy-smart-contract/remix), or
[any other environment](../../../how-to/deploy-smart-contract).
