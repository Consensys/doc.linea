...
You can use [Irys](../../../build/tools/permanent-data/irys/overview) to create an NFT on Linea in three steps:
...
one of [the audited ThirdWeb contracts](../../../how-to/deploy-smart-contract/thirdweb) to learn more.

You can also [deploy this minimal contract using Remix](../../../how-to/deploy-smart-contract/remix).
...
This guide covers using the [Irys CLI](../../../build/tools/permanent-data/irys/irys-quickstart#irys-cli) 
to upload your assets to Irys. You can also do the same using the [Irys SDK](../../../build/tools/permanent-data/irys/irys-quickstart#irys-sdk).
...
using [the contract you deployed on Linea](../../../how-to/deploy-smart-contract).
