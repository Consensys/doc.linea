...
This tutorial will walk you through building a simple React app that allows users to connect their
wallet and send USDC transactions over Linea Sepolia.

## Prerequisites

- Install [Node.js (16+)](https://nodejs.org/) installed (comes with `npm`).
