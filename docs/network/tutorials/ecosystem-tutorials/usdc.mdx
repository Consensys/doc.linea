---
title: Transfer USDC on Linea
description: Build a simple dapp to transfer USDC on Linea.
image: /img/socialCards/usdc-quickstart.jpg
---

USDC, [issued by Circle](https://developers.circle.com/stablecoins/what-is-usdc), enables the seamless
transfer of digital dollars on the Linea network using a smart contract. 
This tutorial walks you through building a simple React app that allows users to connect their wallet
and send USDC transactions over Linea Sepolia.

## Prerequisites

- Install [Node.js](https://nodejs.org/) version 16 or later (comes with `npm`).
- Install the [MetaMask](https://metamask.io) browser extension.
- Fund your wallet with:
  - Native gas tokens (ETH on Linea Sepolia) to cover transaction fees.
  - USDC tokens for testing. ([Use a faucet](../../build/get-testnet-eth.mdx) to get 
...
### 2. Configure blockchain clients
...
### 4. Implement wallet connection and USDC transfer
