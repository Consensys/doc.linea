...
sidebar_position: 5
image: /img/socialCards/messaging.jpg
---
...
(such as `L1TokenBridge` triggering mint on the `L2TokenBridge`),
...
<details>
  ...
  **L2 &rarr; L1:**
  ...
  See our [main bridge page](../how-to/bridge.mdx) for more information on the 
...
Run a postman by cloning the [Linea monorepo](https://github.com/LFDT-Lineth/lineth-monorepo) 
locally and following the instructions in the [postman README](https://github.com/LFDT-Lineth/lineth-monorepo/tree/main/postman#readme).
...
Refer to the [SDK README](https://github.com/LFDT-Lineth/lineth-monorepo/tree/main/sdk#readme) for 
...
<div class="center-container">
  <div class="img-large">
    <img
      src="/img/technology/message_service/reference/Linea_contract_write_as_proxy.png"
      alt="Linea contract write as proxy"
    />
  </div>
</div>
...
`claimMessage` rather than `claimMessageWithProof`. See the [release notes](../../changelog/release-notes.mdx#alpha-v2) 
...
<Tabs className="my-tabs">
  <TabItem value="L1 &rarr; L2">
    ...
    <div class="center-container">
      <div class="img-large">
        <img
          src="/img/technology/message_service/reference/Linea_contract_write_as_proxy_claimMessage_form.png"
          alt="Linea contract write as proxy claimMessage form"
        />
      </div>
    </div>
