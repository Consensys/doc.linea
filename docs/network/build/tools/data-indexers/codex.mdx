...
[Codex](https://www.codex.io/) is a blockchain data API for real-time and historical DeFi data. Linea is fully supported. Meaningall Codex data primitives (tokens, prices, charts, holders, wallets, trades, and live subscriptions) are available for Linea, backed by indexing 80+ million tokens, 700 million wallets, and 28 billion transactions across 80+ networks.
...
For push-based delivery without a persistent WebSocket, Codex webhooks POST on-chain events to your server as they occur.
