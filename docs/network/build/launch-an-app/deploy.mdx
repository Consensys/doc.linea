...
sidebar_position: 0
pagination_next: network/build/launch-an-app/app
...
[Get some Linea Sepolia ETH](../get-testnet-eth.mdx).
...
refer to our [contract templates section](../tools/contracts-templates/index.mdx) for more inspiration. 
...
To deploy a contract, you need to interact with the blockchain, which means you need an [RPC  endpoint](../tools/node-providers/index.mdx) 
...
You can also find alternative public and private RPC endpoints on our [node providers page](../tools/node-providers/index.mdx).
...
with Solidity 0.8.19 or lower](../../overview/ethereum-differences.mdx), so we need to make some
adjustments.
...
- [Node providers](../tools/node-providers/index.mdx)
