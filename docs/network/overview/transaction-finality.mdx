...
When you submit a transaction on Linea, it follows this path: the <GlossaryTerm term="Sequencer">sequencer</GlossaryTerm>
validates and includes it in an L2 block, reaching <GlossaryTerm term="Soft finality">soft
