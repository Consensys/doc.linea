...
- The transaction is cryptographically proven on Ethereum
- It is anchored to Ethereum once the L1 verification transaction reaches Ethereum finality
...
where Ethereum L1 settlement assurances are needed.
