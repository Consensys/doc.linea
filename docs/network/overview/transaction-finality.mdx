...
When your transaction is included in a Linea block and state is updated, it has reached **soft
finality**. This happens within approximately 2 seconds—Linea's block time.
...
the Linea rollup contract on Ethereum, and two epochs have elapsed.
