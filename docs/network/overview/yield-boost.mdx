...
Importantly, the Yield Boost design ensures that ETH withdrawals are always available. The user deposit remains redeemable at all times through layered, permissionless withdrawal mechanisms designed to withstand periods of elevated exit demand.
