...
Importantly, the Yield Boost design ensures that user withdrawals are always available. The user deposit remains redeemable at all times through layered, permissionless withdrawal mechanisms designed to withstand periods of elevated exit demand.
...
- For liquidity providers: Selected liquidity providers will receive competitive and sustainable yields funded by real, Ethereum-native rewards. This supports a "set it and forget it" model that will reduce the turnover of providers chasing incentives across different protocols.
