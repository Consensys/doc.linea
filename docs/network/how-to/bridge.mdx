...
it manually, as it will no longer be displayed in the native bridge app. See our
[message service reference page](../build/send-receive-messages.mdx#claim-old-messages)
