...
it manually, as it will no longer be displayed in the native bridge app. See our [message service reference page](../../protocol/architecture/interoperability/message-service/reference.mdx#claim-old-messages) 
