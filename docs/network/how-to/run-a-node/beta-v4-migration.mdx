...
- **Linea Mainnet**
Date: Wednesday, December 3rd at 9:49pm UTC:
...
#### Sepolia Testnet:
- **Besu & Maru versions**: See the latest versions in the [Sepolia docker-compose.yml](https://github.com/LFDT-Lineth/lineth-monorepo/blob/main/docs/getting-started/linea-sepolia/docker-compose.yml)
- **Geth**: See version and configuration in the [Sepolia Geth docker-compose.yml](https://github.com/LFDT-Lineth/lineth-monorepo/blob/main/docs/getting-started/linea-sepolia/docker-compose.yml)
- **Other EL clients**: Check for Fusaka-compatible versions

#### Mainnet:
- **Besu & Maru versions**: See the latest versions in the [Mainnet docker-compose.yml](https://github.com/LFDT-Lineth/lineth-monorepo/blob/main/docs/getting-started/linea-mainnet/docker-compose.yml)
- **Geth**: See version and configuration in the [Mainnet Geth docker-compose.yml](https://github.com/LFDT-Lineth/lineth-monorepo/blob/main/docs/getting-started/linea-mainnet/docker-compose.yml)
- **Other EL clients**: Check for Fusaka-compatible versions
...
- Step 1: Get your Ethstats key
Each node runner needs a unique Ethstats key. Contact Linea technical support to request your key (one key per organization).
- Step 2: Add the flag to your Execution Layer client
Replace your-node-name with a unique identifier for your node (e.g., mycompany-node-1) and YOUR_ETHSTATS_KEY with the key provided by the Linea technical support team:
...
- **Sepolia**: [docker-compose.yml](https://github.com/LFDT-Lineth/lineth-monorepo/blob/main/docs/getting-started/linea-sepolia/docker-compose.yml)
- **Mainnet**: [docker-compose.yml](https://github.com/LFDT-Lineth/lineth-monorepo/blob/main/docs/getting-started/linea-mainnet/docker-compose.yml)
...
See the [Beta v4.0 release notes](../../../changelog/release-notes.mdx#beta-v40) for the scheduled hard fork 
dates.
...
Maru and Linea Besu now embed the network configuration (including genesis) in
their images — Maru via `--network linea-mainnet` and Linea Besu via its bundled
profile — so you no longer download separate genesis files for them. Geth still
requires a genesis file:
- [Geth](https://github.com/LFDT-Lineth/lineth-monorepo/blob/main/docs/getting-started/linea-mainnet/geth/geth-genesis.json)
