...
<Tabs className="my-tabs">
  <TabItem value="Linea monorepo" label="Linea monorepo">
    ...
    [`/docs/getting-started` directory](https://github.com/Consensys/linea-monorepo/tree/main/docs/getting-started),
    in either the [linea-mainnet](https://github.com/Consensys/linea-monorepo/tree/main/docs/getting-started/linea-mainnet)
    or [linea-sepolia](https://github.com/Consensys/linea-monorepo/tree/main/docs/getting-started/linea-sepolia)
    directories.
