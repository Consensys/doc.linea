...
Install and run a Besu node if you want to follow the Linea network by maintaining a local copy of
the blockchain. However, if you want to interact with the network and use Linea-specific methods and
features, you should [install Linea Besu](./linea-besu.mdx) instead.

::::

You can run Besu using Docker or from a binary distribution. Docker is the default path; the binary
