...
:::info important
Install and run Erigon to maintain a local copy of the blockchain and serve standard Ethereum
...
<Tabs groupId="Mainnet-Testnet" className="my-tabs">
  ...
  [`geth-genesis.json`](https://github.com/LFDT-Lineth/lineth-monorepo/blob/main/docs/getting-started/linea-sepolia/geth/geth-genesis.json)
  file from the Linea monorepo. Save it in your Erigon data directory as `genesis.json`.
