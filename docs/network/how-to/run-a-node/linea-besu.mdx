...
<Tabs groupId="networks" className="my-tabs">
  ...
  <TabItem value="Linea Sepolia" label="Linea Sepolia">
    ...
    Download the appropriate `.yaml` file for your use case:
    - [`basic-sepolia`](https://github.com/LFDT-Lineth/lineth-monorepo/blob/main/linea-besu/package/docker/docker-compose-basic-sepolia.yaml): Creates a basic follower node on Linea Sepolia with no plugins enabled.
