...
profiles in the [Linea Besu package](https://github.com/LFDT-Lineth/lineth-monorepo/tree/main/linea-besu/package).
Advanced profiles enable extra Linea features such as `linea_estimateGas`.

:::warning
The `advanced` profile option doesn't currently support macOS/ARM. Please use Linux/ARM or
Windows/X86_64.
:::

We recommend using Linea Besu over standard Besu if you intend to run a node to interact with the
blockchain, rather than just following it. Use Linea Besu if:
...
To run a Linea Besu node, access the [`/docker` directory](https://github.com/LFDT-Lineth/lineth-monorepo/tree/main/linea-besu/package/docker)
...
<Tabs groupId="Mainnet-Testnet" className="my-tabs">
  <TabItem value="Mainnet" label="Mainnet">
    ...
    - [`basic-mainnet`](https://github.com/LFDT-Lineth/lineth-monorepo/blob/main/linea-besu/package/docker/docker-compose-basic-mainnet.yaml): Creates a basic node on Linea Mainnet with no plugins enabled.
    - [`advanced-mainnet`](https://github.com/LFDT-Lineth/lineth-monorepo/blob/main/linea-besu/package/docker/docker-compose-advanced-mainnet.yaml): Creates an advanced node on Linea Mainnet with plugins that enable support
  ...
  <TabItem value="Linea Sepolia" label="Linea Sepolia">
    ...
    Download the appropriate `.yaml` file for your use case:
    - [`basic-sepolia`](https://github.com/LFDT-Lineth/lineth-monorepo/blob/main/linea-besu/package/docker/docker-compose-basic-sepolia.yaml): Creates a basic node on Linea Sepolia with no plugins enabled.
    - [`advanced-sepolia`](https://github.com/LFDT-Lineth/lineth-monorepo/blob/main/linea-besu/package/docker/docker-compose-advanced-sepolia.yaml): Creates an advanced node on Linea Sepolia with plugins that enable support
    for `linea_estimateGas` and the `finalized` block parameter tag.
...
[Download the latest version](https://github.com/LFDT-Lineth/lineth-monorepo/releases) of the Linea
Besu package from the releases page.
...
The `linea-besu-package-<version>.tar.gz` is a compressed file; move it to the directory of your
choice and extract it.
...
<Tabs groupId="Mainnet-Testnet" className="my-tabs">
  <TabItem value="Mainnet" label="Mainnet">
    ...
    - `basic-mainnet`: Creates a basic node on Linea Mainnet with no plugins enabled.
  ...
  <TabItem value="Linea Sepolia" label="Linea Sepolia">
    Select one according to your preferences:
    - `basic-sepolia`: Creates a basic node on Linea Sepolia with no plugins enabled.
...
[Linea Besu package README](https://github.com/LFDT-Lineth/lineth-monorepo/blob/main/linea-besu/package/README.md).
