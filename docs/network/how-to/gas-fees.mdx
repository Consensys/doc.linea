...
See our [API reference](../../api/reference/linea-estimategas.mdx), or our [technology section](../../protocol/gas.mdx) for more information about how gas works on Linea. 
...
It can also help prevent transactions from being rejected due to exceeding [module limits](../../protocol/prover/prover-limits.mdx).
