...
See our [API reference](../../api/reference/linea-estimategas.mdx), or our [technology section](../../protocol/tokenomics/gas.mdx) for more information about how gas works on Linea. 
