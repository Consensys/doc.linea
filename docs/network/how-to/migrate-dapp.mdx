...
Your dapp's existing contracts must be deployed on Linea. [Part one](../build/launch-an-app/deploy.mdx) 
...
You may need to update your dapp with Linea chain information, which our [connect guide](../quickstart/connect.mdx)
covers.

## RPC providers

Most major RPC providers support Linea RPC endpoints. Visit our [RPC providers page](../build/tools/node-providers/index.mdx) 
...
Multiple [libraries](../build/tools/libraries), including Wagmi and Viem, support Linea wallet 
connectors. 
