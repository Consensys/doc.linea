...
1. Go to the [L1Resolver contract on Etherscan](https://etherscan.io/address/0x1507cE9421232FDBd302f5EbE4590F8D77FeBBFF#writeContract).
...
1. Select **Custom Resolver** and add the address `0x1507cE9421232FDBd302f5EbE4590F8D77FeBBFF`.
