...
:::info[ENS resolver deprecating soon]

The ENS resolver contract will soon be redeployed with a new contract address. You will need to update your configuration to point to the new L1Resolver address. Information about the redeployment date and the new contract address will be provided here soon.

For any questions, contact [Linea Support](https://support.linea.build/).
:::
