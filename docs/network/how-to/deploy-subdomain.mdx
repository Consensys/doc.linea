...
The ENS resolver contracts were redeployed as part of the Small Fields upgrade 
...
| --- | --- |
| `Poseidon2` | TBD |
| `SparseMerkleProof` | TBD |
| `LineaSparseProofVerifier` | TBD |
| `L1Resolver` | TBD |

For Sepolia (deployed March 2, 2026), contact [Linea Support](https://support.linea.build/) 
...
these subdomains to your L1 domain on L1 for [CCIP resolution](../build/tools/cross-chain/ccip-read.mdx) to work.
...
1. Go to the [Linea Custom Resolver contract on Etherscan](https://etherscan.io/address/TBD#writeContract).
...
1. Select **Custom Resolver** and add the address `TBD`.
