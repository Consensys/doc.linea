...
Linea Mainnet is upgraded on an ongoing basis.
Security is a top priority, and we continuously work to strengthen the guarantees available to users.
This page describes the current threats and security measures you should understand before using Linea.
