...
sidebar_position: 2
pagination_next: network/quickstart/app
...
refer to our [contract templates section](../build/tools/contracts-templates/index.mdx) for more inspiration. 
...
To deploy a contract, you need to interact with the blockchain, which means you need an [RPC  endpoint](../build/tools/node-providers/index.mdx) 
...
You can also find alternative public and private RPC endpoints on our [node providers page](../build/tools/node-providers/index.mdx).
...
- [Node providers](../build/tools/node-providers/index.mdx)
