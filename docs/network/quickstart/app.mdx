...
pagination_prev: network/quickstart/deploy
...
- Build in [account abstraction](../build/tools/account-abstraction/index.mdx) features to make your
app more accessible and user-friendly.
- Accelerate development by using audited, reliable [contract templates](../build/tools/contracts-templates/index.mdx).
- Leverage an [oracle](../build/tools/oracles/index.mdx) to fetch data, such as token prices, and
