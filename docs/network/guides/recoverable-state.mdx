...
Use this feature page to understand how to reconstruct Linea's state.
...
## Need to recover state from Public Linea?

This guide provides details on how to recover state from the Public Linea network.
...
To learn how to run a Linea Besu node, see our
[guide](../../network/how-to/run-a-node/linea-besu.mdx).
