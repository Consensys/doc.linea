...
- Deploy NFT contracts on Linea and [have images and metadata on Irys](../../../tutorials/ecosystem-tutorials/irys/irys-nfts)
...
Transaction metadata can be queried using the [Irys's GraphQL](../irys/irys-querying.mdx).
