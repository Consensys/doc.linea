...
- Introduces forced transactions, a manual submission mechanism that allows users to submit
  transactions directly to the L1. More information [here](../protocol/architecture/forced-transactions.mdx).
