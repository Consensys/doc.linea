...
- Introduces [forced transactions](../protocol/forced-transactions.mdx), a manual submission mechanism that allows users to submit transactions directly to the L1.
