...
import { ChangelogEntry, ChangelogDate } from "@site/src/components/changelog/ChangelogEntry";

<p className="changelog-subtitle">Latest network, protocol, and tooling updates for builders.</p>

:::info Linea Security Council transactions

We maintain a record and brief explanation of [Linea Security Council transactions](./security-council-record.mdx).

:::

## Beta v6.0

<ChangelogDate mainnet="March 2026" sepolia="March 2026" />

<ChangelogEntry tag="upgrade">

Switches prover to small fields, enabling faster proof generation.

</ChangelogEntry>

<ChangelogEntry tag="action-required">

**This change deprecates the ENS resolver contract; you will need to update your configuration to point to the new contract address.** More information [here](../network/how-to/deploy-subdomain.mdx).
...
<ChangelogDate mainnet="23 February 2026" sepolia="21 December 2025" />

<ChangelogEntry tag="feature">

Implements Yield Boost, a protocol-level mechanism to stake ETH from the canonical Linea Bridge, and distribute rewards to the L2 ecosystem. More documentation coming soon.
...
<ChangelogEntry tag="feature" title="Maru consensus client">
...
Eliminates the need for the sequencer to enforce module limits, as the prover
...
100% of EVM operations will be covered by our zero-knowledge proofs, guaranteeing
...
<ChangelogDate mainnet="April 28, 2025" sepolia="April 7, 2025" />
...
<ChangelogDate mainnet="September 18" sepolia="September 18" />
...
See our [guide](../network/how-to/finalized-block.mdx) for more.
...
<ChangelogEntry tag="feature" title="CCIP Read">
...
<ChangelogEntry tag="upgrade" title="linea_estimateGas mainnet activation">
...
<ChangelogEntry tag="performance" title="Smart contract gas optimization">
...
<ChangelogEntry tag="feature" title="Bridge to a different recipient">
