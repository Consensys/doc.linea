...
**Linea Mainnet: March 2026**

**Linea Sepolia: March 2026**
...
- Introduces [forced transactions](../protocol/architecture/forced-transactions.mdx), a manual submission mechanism that allows users to submit transactions directly to the L1.
