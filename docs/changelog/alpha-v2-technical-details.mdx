...
The data compression algorithm is lossless, and can achieve compression ratios of up to 15:1. This affords Linea the ability to submit data about far more transactions in each batch: before Alpha v2, Linea averaged approximately 150 transactions per batch; afterwards, it averages approximately 1,500.
