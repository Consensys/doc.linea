...
1. [Funded with test tokens](/use-mainnet/fund)
...
1. Go to the [ERC20 contract of your choice](/use-mainnet/info-contracts#token-contract-addresses-and-bridges) on Etherscan docs
