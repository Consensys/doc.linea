...
:::note The `docker-compose.yml` has besu configurations that won't be running and shouldn't affect your node. If you see anything related to besu in your logs, it can be ignored.
