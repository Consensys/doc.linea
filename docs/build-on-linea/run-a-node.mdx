...
<Tabs className="my-tabs">
 ...
 Download [docker-compose.yml](static/files/docker-compose.yml) and [genesis.json](pathname:///files/genesis.json)
 ...
 Download [docker-compose.yml](static/files/testnet/docker-compose.yml) and [l2-genesis-linea-goerli.json](pathname:///files/l2-genesis-linea-goerli.json)
