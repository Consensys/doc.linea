...
Infura has deprecated L1 Goerli, and the link between it and Linea Goerli will never be 
recovered. No finalization or bridging will be possible on Linea Goerli, although the chain will 
continue to run as normal (albeit with potential performance issues).
