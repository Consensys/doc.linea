...
- Decide on the maximum size you want for the volume. We'll use 100GB for the purposes of this 
explanation, but please refer to the [Geth](use-binary/#disk-space-geth) or [Besu](use-binary/#disk-space-besu)
explanation to help choose the value.
...
- Decide on the maximum size for the volume. We'll use 100GB for the purposes of this 
explanation, but please refer to the [Geth](use-binary/#disk-space-geth) or [Besu](use-binary/#disk-space-besu)
explanation to help choose the value.
