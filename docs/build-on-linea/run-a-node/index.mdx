...
If you're currently running a Linea node, you **must** download the latest version of the genesis file as soon as possible, then re-initialize and restart your node. 

We're carrying out some network upgrades to increase performance, and this includes changing the block time in the genesis file to 1 second. 

For further details and specific instructions about the actions you need to take, see [here](./docs/run-a-node/update-genesis-file.md).
