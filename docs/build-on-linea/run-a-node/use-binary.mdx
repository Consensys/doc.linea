...
To limit disk space required, we recommend you configure Besu to use the [Bonsai](https://besu.hyperledger.org/23.4.0/public-networks/concepts/data-storage-formats#bonsai-tries)
data storage format, which prunes orphaned nodes and old branches. You can read more about Bonsai
and saving disk space [here](https://wiki.hyperledger.org/display/BESU/Limit+Trie+Logs+for+Bonsai).
