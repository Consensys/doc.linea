...
Set up the required and recommended hardware and all the utilities. You can find the recommendations from Geth
[here](https://geth.ethereum.org/docs/getting-started/hardware-requirements).
...
### Step 3. Define disk space volume
