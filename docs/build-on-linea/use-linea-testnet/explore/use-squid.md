...
2. Ensure your wallet is [configured to use Linea](/build-on-linea/use-linea-testnet/set-up-your-wallet.mdx)
...
We will be using [Linea’s Faucet](https://faucet.goerli.linea.build) to get USDC. For more information on how to use the faucet, check out [the docs](/build-on-linea/use-linea-testnet/fund.md).
