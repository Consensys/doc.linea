...
To support these new features, we implemented changes to our smart contracts. The audited commit for this update can be found [here](https://github.com/Consensys/linea-contracts-audit/commit/99039ebc8d6cb3009cf46286d5de4c484e03bc81). 

Two independant audits have been perfomed for this update. Reports can be found here: 

- Diligence: https://consensys.io/diligence/audits/2024/01/linea-contracts-update/

- Open Zeppelin: (Public link to come)
...
:::info
[Note] If you are using the Linea Bridge UI, then this is already done for you. If you are a partner/user who manages their claiming outside of the Bridge UI, then we recommend looking at the updated [SDK](/build-on-linea/linea-sdk).
