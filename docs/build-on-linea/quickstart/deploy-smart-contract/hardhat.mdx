...
2. [Funded your wallet with Linea ETH](../../use-linea-testnet/fund.md#get-test-eth-on-linea)
...
<img src={require('@site/static/img/docs/build-on-linea/quickstart/deploy-smart-contract/dashboard_network.png').default}></img>
<br></br>
...
<img src={require('@site/static/img/docs/build-on-linea/quickstart/deploy-smart-contract/dashboard_deploy.png').default}></img>
<br></br>
