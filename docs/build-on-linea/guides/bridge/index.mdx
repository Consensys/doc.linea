...
We recommend you use the [official Linea token bridge](/use-mainnet/move-funds/bridge/how-to-bridge-eth) 
for bridging between Linea and Ethereum.

**Bridge ERC-20 tokens**

Again, we recommend the official bridge; ERC-20-specific instructions are
[here](/use-mainnet/move-funds/bridge/how-to-bridge-erc20-tokens).
...
### [The canonical token bridge](/architecture/stack/bridges/canonical-token-bridge)
