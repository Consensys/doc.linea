...
[l2-genesis-uat.json](pathname:///files/genesis.json)

### Step 3

Define a volume of at least `100GB`, more if you want to future-proof your and mount the Geth `datadir` to `geth-linea-data`
...
```bash
geth --datadir ./geth-linea-data init ./l2-genesis-uat.json
```
