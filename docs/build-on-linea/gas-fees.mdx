...
:::info Developers can access the Gas API used by MetaMask through Infura for transactions submitted from the backend! Go [here](https://www.infura.io/platform/gas-api) for more details. :::
