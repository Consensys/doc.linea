...
:::info
Developers can access the Gas API used by MetaMask through Infura for transactions submitted from the backend! Go [here](https://metamask.io/news/developers/metamasks-gas-api-is-now-available-to-any-developer-via-infura/) for more details.
:::
