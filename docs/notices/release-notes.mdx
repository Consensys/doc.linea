...
We maintain a record and brief explanation of [Linea Security Council transactions](/notices/security-council-record).
...
precompiles, such as `PUSH0` and `MCOPY`, considerably shortening the list of Linea's [differences with Ethereum](../get-started/build/ethereum-differences.mdx).
...
Beta v4.0 introduces a new consensus client, [Maru](../get-started/how-to/run-a-node/maru.mdx), 
...
See our [guide](../get-started/how-to/finalized-block.mdx) for more.
...
securely querying data on Linea. See our [page on CCIP Read](../get-started/tooling/cross-chain/ccip-read.mdx) 
