...
`linea_estimateGas` is the recommended method for estimating gas on Linea. See our [API reference](/api/reference/linea-estimategas.mdx) and [guide](/public/how-to/gas-fees.mdx) for more information. 
