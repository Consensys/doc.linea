...
[Besu](../public/how-to/run-a-node/linea-besu.mdx#run-using-docker) or [Geth](../public/how-to/run-a-node/geth.mdx), 
and the consensus layer [Maru](../public/how-to/run-a-node/maru.mdx))
...
- **Components:** [Besu](../public/how-to/run-a-node/linea-besu.mdx#run-using-docker) with sequencer plugins
...
- **Components:** [Besu](../public/how-to/run-a-node/linea-besu.mdx#run-using-docker) with tracer plugins
