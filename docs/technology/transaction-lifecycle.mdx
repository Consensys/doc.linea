...
[Besu](../get-started/how-to/run-a-node/linea-besu.mdx#run-using-docker) or [Geth](../get-started/how-to/run-a-node/geth.mdx), 
...
- **Components:** [Besu](../get-started/how-to/run-a-node/linea-besu.mdx#run-using-docker) with sequencer plugins
...
- **Components:** [Besu](../get-started/how-to/run-a-node/linea-besu.mdx#run-using-docker) with tracer plugins
