...
LINEA will have a **total supply of 72,009,990,000**.
...
<table>
	...
	<tr>
		<td>Ecosystem</td>
		<td>85%</td>
		<td>75% for a long-term Ecosystem Fund, and 10% for early adopters.</td>
	</tr>
		<td>Consensys treasury</td>
		<td>15%</td>
		<td>This allocation has a five-year cliff and then a five-year linear vest.
		The tokens will be non-transferrable until the cliff. Consensys will hold
		the tokens long-term for alignment and to support Linea and its ecosystem.</td>
	<tr>
	</tr>
</table>
...
The initial airdrop for early adopters, comprising 10% of the supply, will include:
- 9% to early adopters
- 1% to strategic builders

The early adopter airdrop for users will be based on onchain activity over the long term, including 
...
be locked for five years and are non-trasnferrable until a vesting schedule is complete.
...
- 20% of net ETH profits (Linea revenue minus layer 1 costs) will be burned on Ethereum (layer 1), 
  reducing ETH supply
- 80% of net ETH profits are converted to Linea and burned, reducing LINEA supply.

As a result, network activity on Linea directly supports both the value of ETH and LINEA. 

## Governance

LINEA provides no governance rights for token holders. 

Instead, the Linea Consortium oversees and guides strategic decisions about the chain and its 
ecosystem. The Consortium includes several reputable and strongly Ethereum-aligned organizations 
whose experience and objectives align closely with Linea's intention of scaling and strengthening 
Ethereum. Consortium members include Status, ENS Labs, Consensys, Sharplink, and Eigen Labs. 

While the Linea Consortium handles the direction of the chain, the Linea Association, a Swiss 
non-profit organization, is responsible for the legal and operational aspects of Linea, including 
token issuance and compliance.  
