...
The token's contract address on both Linea Mainnet and Ethereum Mainnet is [`0x1789e0043623282D5DCc7F213d703C6D8BAfBB04`](https://lineascan.build/address/0x1789e0043623282D5DCc7F213d703C6D8BAfBB04).

:::note[Need help?]

This explains the rationale behind token distribution. If you're looking for help with claiming your 
airdrop, using the token, or any other common issues, see the [Linea support page](https://support.linea.build/linea-hub/airdrop).
