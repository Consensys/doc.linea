...
- [Documentation for Linea infrastructure runners](https://github.com/LFDT-Lineth/lineth-monorepo/tree/main/docs)
...
Rule of thumb:
- If a page answers “how does Linea work?” → Protocol
> Content primarily explains cryptographic primitives, zk proofs, or protocol mechanics.
- If it answers “how do I run Linea?” → Stack
> Can I do X?” → belongs in Features
> “How do I do X?” → belongs in Guides
> “What is X?” → belongs in How It Works
- If it answers "how do I work with Mainnet" → Network
...
order to `docs/protocol/reference/zero-knowledge-glossary.mdx`. Then, make a pull request and tag us for review!
