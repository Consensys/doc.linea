  ...
  apiSidebar: [
    ...
    { type: "doc", id: "api/quickstart", className: "intro-section-item" },
    {
      ...
      items: [
        ...
        {
          type: "category",
          label: "Standard Ethereum JSON-RPC API",
          items: [
            "api/reference/eth-accounts",
            "api/reference/eth-blocknumber",
            "api/reference/eth-call",
            "api/reference/eth-chainid",
            "api/reference/eth-estimategas",
            "api/reference/eth-feehistory",
            "api/reference/eth-gasprice",
            "api/reference/eth-getbalance",
            "api/reference/eth-getblockbyhash",
            "api/reference/eth-getblockbynumber",
            "api/reference/eth-getblockreceipts",
            "api/reference/eth-getblocktransactioncountbyhash",
            ...
            "api/reference/eth-gettransactionbyhash",
            "api/reference/eth-gettransactioncount",
            "api/reference/eth-gettransactionreceipt",
            "api/reference/eth-maxpriorityfeepergas",
            "api/reference/eth-newfilter",
            "api/reference/eth-newblockfilter",
            "api/reference/eth-getfilterchanges",
            "api/reference/eth-getfilterlogs",
            "api/reference/eth-uninstallfilter",
            {
              type: "html",
              value: "<div class='sidebar-section-divider'><span style='font-size: 14px;'>Debug and trace methods</span></div>",
            },
            "api/reference/debug-tracetransaction",
            "api/reference/debug-traceblockbynumber",
            "api/reference/debug-traceblockbyhash",
            "api/reference/debug-tracecall",
            "api/reference/trace-transaction",
            "api/reference/trace-block",
