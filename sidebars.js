...
const sidebars = {
      ...
      items: [
        {
          ...
          link: {
            type: "doc",
            id: "network/build/quickstart/deploy",
          },
          items: [
            "network/build/quickstart/deploy",
            "network/build/quickstart/app",
            "network/build/quickstart/hub",
            "network/build/quickstart/hub-reviews",
            "network/build/quickstart/events"
          ],
        },
        "network/build/ethereum-differences",
        "network/build/network-info",
        "network/build/contracts",
        "network/build/block-explorers",
        "network/build/dapp-support",
      ],
    },
    {
      type: "category",
      ...
      collapsible: false,
      items: [
        "network/how-to/get-testnet-eth",
        {
          type: "category",
          label: "Deploy a smart contract",
          link: {
            type: "doc",
            id: "network/how-to/deploy-smart-contract/index",
          },
          items: [
        ...
        },
        {
          ...
          link: {
            type: "doc",
            id: "network/how-to/verify-smart-contract/index",
          },
          items: [
        ...
        "network/how-to/finalized-block",
        {
          ...
          link: {
            type: "doc",
            id: "network/how-to/run-a-node/index",
          },
          items: [
        ...
        "network/how-to/verify-users-with-proof-of-humanity",
      ],
    },
  ],
  toolsSidebar: [
  ...
  protocolSidebar: [
    ...
    "protocol/canonical-token-bridge",
    {
      type: "category",
      ...
      link: {
        type: "doc",
        id: "protocol/message-service/index",
      },
      items: [
        "protocol/message-service/reference",
      ],
    },
